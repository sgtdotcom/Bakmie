import { MenuItem, Table, User, Category } from '@/types'
...
export const INITIAL_USERS: User[] = [
  ...
  { id: 3, username: 'cashier1',   password: 'cash123',  name: 'Kasir 1',       role: 'cashier'    },
  { id: 4, username: 'waitress1',  password: 'wait123',  name: 'Pelayan 1',     role: 'waitress'   },
  { id: 5, username: 'dapur1',     password: 'dapur123', name: 'Dapur 1',       role: 'dapur'      },
]
...
// Kategori bisa ditambah/edit/hapus/diurutkan oleh Admin
export const INITIAL_CATEGORIES: Category[] = [
  { id: 'cat_1',  name: 'Menu Utama',  emoji: '🍜', order: 1 },
  { id: 'cat_2',  name: 'Tambahan',    emoji: '➕', order: 2 },
  { id: 'cat_3',  name: 'Roti Bakar',  emoji: '🍞', order: 3 },
  { id: 'cat_4',  name: 'Dimsum',      emoji: '🥟', order: 4 },
  { id: 'cat_5',  name: 'Jus',         emoji: '🥤', order: 5 },
  { id: 'cat_6',  name: 'Smoothies',   emoji: '🫐', order: 6 },
  { id: 'cat_7',  name: 'Kopi',        emoji: '☕', order: 7 },
  { id: 'cat_8',  name: 'Milk Based',  emoji: '🥛', order: 8 },
  { id: 'cat_9',  name: 'Teh',         emoji: '🍵', order: 9 },
  { id: 'cat_10', name: 'Yoghurt',     emoji: '🍶', order: 10 },
]

// Array nama kategori untuk dropdown & filter — include 'Semua' di depan
